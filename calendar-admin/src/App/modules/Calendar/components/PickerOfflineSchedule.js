              ...
              <>
                ...
                >
                  {({ open }) => (
                    <button
                      onClick={open}
                      className="text-white rounded-[3px] bg-primary text-[13px] h-[35px] lg:px-4 px-3"
                      type="button"
                    >
                      <svg
                ...
                <button
                  ...
                  className="text-white rounded-[3px] bg-danger text-[13px] h-[35px] lg:px-4 px-3"
                  type="button"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  <span className="hidden lg:block">Huỷ</span>
                </button>
              </>
            ) : (
              <PickerTakeBreak
