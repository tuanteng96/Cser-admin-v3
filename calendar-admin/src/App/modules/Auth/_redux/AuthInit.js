    ...
    async function requestUser() {
      if (isDevCode()) {
        window.Info = {
          ...
          token:
            'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJBdXRoMlR5cGUiOiJVc2VyRW50IiwiSUQiOiIxIiwiVG9rZW5JZCI6IjU3Mzg1NzkwNTczODYyODUiLCJuYmYiOjE3NTA5MjE2NzQsImV4cCI6MTgzNzMyMTY3NCwiaWF0IjoxNzUwOTIxNjc0fQ.ZSWcMnOUmwZyV2VzsDoPhfd5YckMdr_AcCLjWe6ADV8',
        };
        window.GlobalConfig = {
          APP: {
            Working: {
