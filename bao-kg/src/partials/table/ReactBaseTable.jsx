              ...
              emptyRenderer={() =>
                !loading && emptyRenderer ? (
                  ...
                  <div className='flex flex-col items-center justify-center h-full dark:bg-dark-aside'>
                    ...
                    <div className='my-2 mt-6 text-xl font-semibold'>Không có dữ liệu</div>
                    <div className="max-w-[400px] text-center font-light leading-6">Thay đổi tùy chọn bộ lọc khác nhau để tìm kiếm dữ liệu.</div>
                  </div>
                )
              }
